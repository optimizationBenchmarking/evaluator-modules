 ...
 * {@link org.optimizationBenchmarking.evaluator.evaluation.impl.abstr.ExperimentSetJob}
...
public abstract class FunctionJob extends ExperimentSetJob {
   ...
   */
  protected IFontStyle getXAxisTitleFont() {
    return null;
  }
   ...
   */
  protected IFontStyle getXAxisTickFont() {
    return null;
  }
   ...
   */
  protected IColorStyle getXAxisColor() {
    return null;
  }
   ...
   */
  protected IStrokeStyle getXAxisStroke() {
    return null;
  }
   ...
   */
  protected IFontStyle getYAxisTitleFont() {
    return null;
  }
   ...
   */
  protected IFontStyle getYAxisTickFont() {
    return null;
  }
   ...
   */
  protected IColorStyle getYAxisColor() {
    return null;
  }
   ...
   */
  protected IStrokeStyle getYAxisStroke() {
    return null;
  }
   ...
   */
  protected IColorStyle getExperimentColor(
      final ExperimentFunction function, final IStyles styles) {
    return null;
  }
   ...
   *         default
   */
  protected IStrokeStyle getExperimentStroke(
      final ExperimentFunction function, final IStyles styles) {
    return null;
  }
   ...
   *         default
   */
  protected IFontStyle getExperimentFont(final ExperimentFunction function,
  ...
  final void _drawChart(final ILineChart2D chart,
    ...
    try (final IAxis xAxis = chart.xAxis()) {
      ...
      if (color != null) {
        xAxis.setAxisColor(color.getColor());
      }

      stroke = this.getXAxisStroke();
      if (stroke != null) {
        xAxis.setAxisStroke(stroke.getStroke());
      }
    ...
    try (final IAxis yAxis = chart.yAxis()) {
      ...
      if (color != null) {
        yAxis.setAxisColor(color.getColor());
      }

      stroke = this.getYAxisStroke();
      if (stroke != null) {
        yAxis.setAxisStroke(stroke.getStroke());
      }
    ...
    for (final ExperimentFunction experimentFunction : data.getData()) {
      ...
      try (final ILine2D line = chart.line()) {
        ...
        if (stroke != null) {
          ...
          line.setStroke(styles.getDefaultStroke().getStroke());
        }
