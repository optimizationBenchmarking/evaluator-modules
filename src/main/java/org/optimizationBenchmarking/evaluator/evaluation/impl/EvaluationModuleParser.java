...
import org.optimizationBenchmarking.evaluator.evaluation.impl.all.ExperimentSetModules;
import org.optimizationBenchmarking.evaluator.evaluation.impl.appendix.AppendixModules;
import org.optimizationBenchmarking.evaluator.evaluation.impl.description.DescriptionModules;
import org.optimizationBenchmarking.evaluator.evaluation.impl.single.ExperimentModules;
...
public class EvaluationModuleParser
    extends InstanceParser<IEvaluationModule> {
  ...
  private static final String[] __prefixes() {
    ...
    ReflectionUtils.addPackageOfClassToPrefixList(ExperimentModules.class,
        paths);
    ReflectionUtils
        .addPackageOfClassToPrefixList(ExperimentSetModules.class, paths);
    ReflectionUtils.addPackageOfClassToPrefixList(DescriptionModules.class,
        paths);
